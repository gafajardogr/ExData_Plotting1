...
with(data1, {
    plot(Global_active_power~sTime, type="l", 
        ylab="Global Active Power (kilowatts)", xlab="")
    plot(Voltage~sTime, type="l", 
        ylab="Voltage (volt)", xlab="")
    plot(Sub_metering_1~sTime, type="l", 
        ylab="Global Active Power (kilowatts)", xlab="")
    lines(Sub_metering_2~sTime,col='Red')
    lines(Sub_metering_3~sTime,col='Blue')
    legend("topright", col=c("black", "red", "blue"), lty=1, lwd=2, bty="n",
    legend=c("Sub_metering_1", "Sub_metering_2", "Sub_metering_3"))
    plot(Global_reactive_power~sTime, type="l", 
